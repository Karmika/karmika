 ...
 * @property string $benf_bank_name
 * @property string $benf_bank_branch
 * @property string $benf_bank_ifsc
 * @property string $created_date
 * @property integer $created_by_user_id
 * @property string $updated_date
 * @property integer $updated_by_user_id
 * @property string $benf_application_status
 * @property string $benf_application_number
...
class BeneficiaryMaster extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['benf_first_name', 'benf_middle_name', 'benf_last_name', 'benf_local_address_taluk', 'employer_full_name', 'emplr_address_line2'], 'string', 'max' => 100],
            [['nationality'], 'string', 'max' => 25],
            [['benf_local_address_line1', 'benf_local_address_line2', 'benf_prmt_address_line1', 'benf_prmt_address_line2', 'emplr_address_line1'], 'string', 'max' => 175],
            [['benf_local_address_district', 'benf_local_address_state', 'benf_prmt_address_taluk', 'benf_prmt_address_district', 'benf_prmt_address_state', 'emplr_address_taluk', 'emplr_address_district', 'emplr_address_state', 'benf_bank_name', 'benf_bank_branch'], 'string', 'max' => 50],
            [['benf_bank_ifsc'], 'string', 'max' => 16],
            [['benf_application_number', 'benf_acknowledgement_number', 'benf_registration_number', 'benf_registration_old_number'], 'string', 'max' => 35],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'benf_application_number' => 'Benf Application Number',
