...
<div class="panel panel-success">
    ...
    <div id="collapse1" class="panel-collapse collapse in">
      <div class="panel-body">
        ...
        <br>
        <br>
		<ul class="list-inline pull-right" ng-show="Beneficiary.actionRequired">
		  <li><button type="button" class="btn btn-warning prev-step">Send for Modifications</button></li>
